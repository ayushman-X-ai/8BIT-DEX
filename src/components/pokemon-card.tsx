...
import { PokemonExplainDialog } from './pokemon-explain-dialog';
...
export function PokemonCard({ pokemon }: PokemonCardProps) {
  ...
  return (
    <Card className="group relative overflow-hidden rounded-lg shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
      <CardContent className="p-0 text-center">
        ...
        <div className="p-4 bg-card">
          ...
          <div className="mt-4">
             <PokemonExplainDialog pokemon={pokemon} />
          </div>
        </div>
      </CardContent>
    </Card>
